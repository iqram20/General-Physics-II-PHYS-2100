...
## Course Description
PHYS 2100 is the second semester of calculus-based General Physics. Topics include electricity and magnetism, electromagnetic waves, optics, and an introduction to modern physics with applications to medicine and technology.

---

## Textbook (Main)
**OpenStax College Physics, Volume 2**  
(Open-access)
## Textbook (Optional)
...
## Important Note
The **Final Exam date and time are assigned by the Registrar and are fixed**.

---

## Instructor
**Dr. Iqram Hussain, PhD**  
